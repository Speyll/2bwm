 ...
 *6)emptycol         */
static const char *colors[] = {"#6c71c4","#073642","#2aa198","#d33682","#268bd2","#002b36","#000000"};
...
///--Menus and Programs---///
static const char* menucmd[] = {"dmenu_run", "-p", "Select a program:", NULL };
...
static const char* script[]  = {"dmenulaunch", NULL };
///--Custom foo---///
...
static key keys[] = {
    ...
    // Change current workspace
       ...
       DESKTOPCHANGE(     0x22,                     2)
       DESKTOPCHANGE(     0x27,                     3)
       DESKTOPCHANGE(     0x28,                     4)
       DESKTOPCHANGE(     0x2d,                     5)
       DESKTOPCHANGE(     0xe8,                     6)
       DESKTOPCHANGE(     0x5f,                     7)
       DESKTOPCHANGE(     0xe7,                     8)
       DESKTOPCHANGE(     0xe0,                     9)
};
